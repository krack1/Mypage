...
<c:if test="${id != null}">
	...
	<tr style="height:45px;">
		...
		<input type="password" name = "pass1" value="${pass1}" onkeyup ="check_Same()" style="width: 100px; border-right:0px; border-left:0px; border-top:0px;  border-bottom:0px;"/>
		</td>
	</tr>
	<tr style="height:45px;">
		<td>
		<div class="title">재입력</div>
		<input type="password" name = "pass2" value="${pass1}" onkeyup = "check_Same()" style="width: 100px; border-right:0px; border-left:0px; border-top:0px;  border-bottom:0px;"/> 
		</td>
	</tr>
...
var emailExp = /^[A-Za-z0-9\-]+\.[A-Za-z0-9\-]+/;
	...
	function check_Same() {
		...
		if(pass1 == "" || pass2 =="") {
			...
			if(pass1 == pass2) {
				if(RegExp.test(pass1) && RegExp.test(pass2)){
